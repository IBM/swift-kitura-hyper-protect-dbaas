...
function killServerProcesses() {
    pid="$(pgrep swiftkiturahypersecuredbaas)"
    if [ "$pid" != "" ]
    then
        echo "killing swiftkiturahypersecuredbaas"
        kill $pid
    fi
